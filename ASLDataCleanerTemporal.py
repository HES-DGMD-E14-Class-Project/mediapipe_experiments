    ...
    def clean_and_save(self):
        ...
        for sign in self.signs_to_process:
            ...
            for parquet_file in parquet_files:
                # Process the file and produce a dataframe
                df = self._read_and_concatenate_parquet_files([parquet_file], sign)
            ...
            # Save Output
            output_filename = os.path.join(self.base_dir, f"cleaned-temporal/{sign}.json")
